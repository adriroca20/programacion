...
import { getAuth ,createUserWithEmailAndPassword , GoogleAuthProvider, signInWithRedirect, getRedirectResult } from "https://www.gstatic.com/firebasejs/9.6.10/firebase-auth.js";
...
const botonInicioSesion=document.getElementById("botonCrearCuenta");
//Listeners
botonInicioSesion.addEventListener("submit",iniciarSesionGoogle);
